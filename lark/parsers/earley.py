...
from .earley_forest import ForestToTreeVisitor, ForestSumVisitor, SymbolNode, CompleteForestToAmbiguosTreeVisitor
...
class Parser:
    ...
    def parse(self, stream, start):
        ...
        forest_tree_visitor_cls = ForestToTreeVisitor if self.resolve_ambiguity else CompleteForestToAmbiguosTreeVisitor
